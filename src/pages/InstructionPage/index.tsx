...
export function Component() {
    return <section className={styles.page}>
        <h1 className={styles.title}>User Guide for "Student Budget" App</h1>
        ...
        <h2 className={styles.title}>Step 1: Authorization</h2>
        ...
        <h2 className={styles.title}>Step 2: Settings and Data Entry</h2>
        ...
        <h2 className={styles.title}>Step 3: Results</h2>
